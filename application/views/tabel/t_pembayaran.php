                            ...
                            <table id="multi-filter-select" class="display table table-striped table-hover" >
                                ...
                                <tbody id="show_data">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url('Pembayaran/cetak_bukti_pembayaran/'.$id)?>" type="button" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-print"></i> Cetak</a></td>
                                    </tr>
                                    <?php
                                    }
                                    ?>
