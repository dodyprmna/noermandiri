                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form action="<?php echo base_url('Profil/aksi_ubah_password')?>" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="login-horizental cancel-wp pull-left">
                                                        <button onclick="<?php echo base_url('Profil')?> type="reset" class="btn btn-danger btn-sm" name="Batal">Batal</button>&nbsp;
