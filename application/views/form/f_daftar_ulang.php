                                                    ...
                                                    <form action="<?php echo base_url('DaftarUlang/aksiTambah')?>" method="POST">
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <input type="text" class="form-control" id="noinduk" name="noinduk" readonly="" value="<?php echo $this->session->userdata('ses_id'); ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <select class="form-control custom-select-value" name="jenjang" id="jenjang">
